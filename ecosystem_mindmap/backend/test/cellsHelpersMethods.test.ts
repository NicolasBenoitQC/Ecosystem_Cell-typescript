...
import { getCellByProps_Id, createDefaultStemCell } from '../database/cells/cells.methods';
...
describe.skip('Helpers methods of communication with the database.', async () => {
    before( async () => {
